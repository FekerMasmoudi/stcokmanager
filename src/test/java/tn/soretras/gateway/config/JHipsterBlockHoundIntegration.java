...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("tn.soretras.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("tn.soretras.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
